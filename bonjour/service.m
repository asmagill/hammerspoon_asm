...
/// hs._asm.bonjour.service:addresses() -> table
/// Method
...
/// hs._asm.bonjour.service:domain() -> string
/// Method
...
/// hs._asm.bonjour.service:name() -> string
/// Method
...
/// hs._asm.bonjour.service:hostname() -> string
/// Method
...
/// hs._asm.bonjour.service:type() -> string
/// Method
...
/// hs._asm.bonjour.service:port() -> integer
/// Method
...
/// hs._asm.bonjour.service:txtRecord([records]) -> table | serviceObject | false
/// Method
...
/// hs._asm.bonjour.service:includesPeerToPeer([value]) -> boolean | serviceObject
/// Method
...
/// hs._asm.bonjour.service:publish([allowRename], [callback]) -> serviceObject
/// Method
...
/// hs._asm.bonjour.service:resolve([timeout], [callback]) -> serviceObject
/// Method
...
/// hs._asm.bonjour.service:monitor([callback]) -> serviceObject
/// Method
...
/// hs._asm.bonjour.service:stop() -> serviceObject
/// Method
...
/// hs._asm.bonjour.service:stopMonitoring() -> serviceObject
/// Method
