...
/// hs._asm.canvas.avplayer:rate([rate]) -> avplayerObject | current value
/// Method
...
/// hs._asm.canvas.avplayer:mute([state]) -> avplayerObject | current value
/// Method
...
/// hs._asm.canvas.avplayer:volume([volume]) -> avplayerObject | current value
/// Method
...
/// hs._asm.canvas.avplayer:ccEnabled([state]) -> avplayerObject | current value
/// Method
...
/// hs._asm.canvas.avplayer:trackProgress([number | nil]) -> avplayerObject | current value
/// Method
...
/// hs._asm.canvas.avplayer:trackRate([state]) -> avplayerObject | current value
/// Method
...
/// hs._asm.canvas.avplayer:playerInformation() -> table | nil
/// Method
...
/// hs._asm.canvas.avplayer:status() -> status[, error] | nil
/// Method
...
/// hs._asm.canvas.avplayer:trackCompleted([state]) -> avplayerObject | current value
/// Method
...
/// hs._asm.canvas.avplayer:trackStatus([state]) -> avplayerObject | current value
/// Method
...
/// hs._asm.canvas.avplayer:time() -> number | nil
/// Method
...
/// hs._asm.canvas.avplayer:duration() -> number | nil
/// Method
...
/// hs._asm.canvas.avplayer:seek(time, [callback]) -> avplayerObject | nil
/// Method
...
// /// hs._asm.canvas.avplayer:allowExternalPlayback([state]) -> avplayerObject | current value
// /// Method
...
// /// hs._asm.canvas.avplayer:externalPlayback() -> Boolean
// /// Method
