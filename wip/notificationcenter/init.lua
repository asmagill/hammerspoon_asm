...
module.notificationNames = _makeConstantsTable(module.notificationNames)
module.deprecatedNotificationNames = _makeConstantsTable(module.deprecatedNotificationNames)
