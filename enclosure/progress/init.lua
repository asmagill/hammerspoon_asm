--- === hs._asm.enclosure.progress ===
---
--- A Hammerspoon module which allows the creation and manipulation of progress indicators for use as a `contentView` for `hs._asm.enclosure` or as a `view` element in `hs._asm.enclosure.canvas`.


local USERDATA_TAG = "hs._asm.enclosure.progress"
