...
static const char *USERDATA_TAG = "hs._asm.enclosure.canvas.matrix" ;
...
/// hs._asm.enclosure.canvas.matrix.identity() -> matrixObject
/// Constructor
...
/// hs._asm.enclosure.canvas.matrix:invert() -> matrixObject
/// Method
...
///  * This is useful when used with [hs._asm.enclosure.canvas.matrix.append](#append) to undo a previously applied transformation without actually replacing all of the transformations which may have been applied to a canvas element.
...
/// hs._asm.enclosure.canvas.matrix:append(matrix) -> matrixObject
/// Method
...
/// hs._asm.enclosure.canvas.matrix:prepend(matrix) -> matrixObject
/// Method
...
/// hs._asm.enclosure.canvas.matrix:rotate(angle) -> matrixObject
/// Method
...
/// hs._asm.enclosure.canvas.matrix:scale(xFactor, [yFactor]) -> matrixObject
/// Method
...
/// hs._asm.enclosure.canvas.matrix:shear(xFactor, [yFactor]) -> matrixObject
/// Method
...
/// hs._asm.enclosure.canvas.matrix:translate(x, y) -> matrixObject
/// Method
...
int luaopen_hs__asm_enclosure_canvas_matrix_internal(lua_State* __unused L) {
    LuaSkin *skin = [LuaSkin shared] ;
