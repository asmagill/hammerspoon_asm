--- === hs._asm.enclosure.canvas.matrix ===
---
--- A sub module to `hs._asm.enclosure.canvas` which provides support for basic matrix manipulations which can be used as the values for `transformation` attributes in the `hs._asm.enclosure.canvas` module.
---
...
local USERDATA_TAG = "hs._asm.enclosure.canvas.matrix"
