...
// added to get rid of compiler warnings; not sure if its correct to be 0, but that's what it was defaulting to
// when giving the warnings, so this does the same, but without the warnings :-)

#define RC_HIDE_J316 0
