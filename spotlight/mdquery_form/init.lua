...
local sortingAttributes = objectMT.sortingAttributes
objectMT.sortingAttributes = function(self, ...)
    local args = table.pack(...)
    if args.n == 0 then
        return sortingAttributes(self)
    elseif args.n == 1 then
        return sortingAttributes(self, ...)
    else
        return sortingAttributes(self, args)
    end
end
