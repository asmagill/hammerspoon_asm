...
-- Note that this is a quick-and-dirty example and could probably be cleaned up, but
-- it should serve as an example of how the Spotlight module could be used in practice.
